...
def can_config(sd,vecu):
    print("Generating CAN code")
    vecu = sd.ActiveProject.ClassicVEcus.Elements[0].GetModuleConfigurationByDefinitionName("Can",1)
    #print(vecu)
    get_bsw = vecu.GetBswPlugins()
    run_bsw = vecu.RunBswPlugin('Generate Can Code')
    #print(get_bsw)
    #print(run_bsw)
    print("CAN code is generated")
